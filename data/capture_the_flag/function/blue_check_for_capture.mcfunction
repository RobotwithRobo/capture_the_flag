...
execute at @e[tag=red_return_point,type=minecraft:armor_stand,limit=1] as @a[distance=..2] if predicate capture_the_flag:blue_banner_die run function capture_the_flag:blue_flag_summon
